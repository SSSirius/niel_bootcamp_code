...
class Cube {
  ...
  float maxZ = 1000;
      //int colr[]={255,255,255,113,113,113,102};
      //int colg[]={51,153,227,227,219,188,102};
      //int colb[]={0,0,0,0,168,244,255};
  int colr[]={75,253,255,1,150,255,254,244};
  int colg[]={255,223,215,153,0,238,157,244};
  int colb[]={254,246,250,228,61,2,117,99};
  ...
  void display(float scoreLow, float scoreMid, float scoreHi, float intensity, float scoreGlobal, boolean isblack) {
    ...
    if (xpos*ypos <40000 && xpos*ypos>2500) {
      ...
      //fill(220-intensity*xpos/4, 120-((xpos-400)/50*intensity), 50-((ypos-600)/50*intensity), ((scoreGlobal-5)/1000)*(200));
      //fill(250-intensity*xpos/4, 120-((xpos-300)/50*intensity), 50-((ypos-300)/50*intensity), 240-(70*intensity));
    int rindex= (int)random(0,7);
    fill(colr[rindex],colg[rindex],colb[rindex], 240-(70*intensity));
