  ...
  void display(float scoreLow, float scoreMid, float scoreHi, float intensity, float scoreGlobal, boolean isblack) {
    ...
    if (isblack) {
      ...
      if (xpos*ypos<40000 && xpos*ypos>2500) {
        fill(random(150, 255), 200+((xpos-600)/50*intensity), 230-((ypos-300)/50*intensity),((scoreGlobal-51/2000)*(150)));
        println(random(150, 255)*3, 200+((xpos-600)/50*intensity), 230-((ypos-300)/50*intensity),((scoreGlobal-51/2000)*(150)));
      } else if (xpos*ypos>40000) { 
        fill(random(180, 255), 120-((xpos-600)/50*intensity), 50-((ypos-600)/50*intensity), ((scoreGlobal-5)/1000)*(200));
      };
    }
